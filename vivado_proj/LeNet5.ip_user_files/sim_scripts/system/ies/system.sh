...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../LeNet5.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../LeNet5.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../LeNet5.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../LeNet5.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"E:/Downloadcache/Xilinx/Vivado/2020.2/data/xilinx_vip/include"
}
