...
entity lenet5_feature_out_conv0_ram is 
    generic(
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 14; 
...
architecture rtl of lenet5_feature_out_conv0_ram is 
...
entity lenet5_feature_out_conv0 is
    generic (
...
architecture arch of lenet5_feature_out_conv0 is
    component lenet5_feature_out_conv0_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    lenet5_feature_out_conv0_ram_U :  component lenet5_feature_out_conv0_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
