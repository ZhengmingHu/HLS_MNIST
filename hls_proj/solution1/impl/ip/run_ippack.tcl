...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 w_conv0_1 W 0x0 "Data signal of w_conv0" {{0 32 w_conv0 W 0 "Bit 31 to 0 of w_conv0"}}} {0x14 w_conv0_2 W 0x0 "Data signal of w_conv0" {{0 32 w_conv0 W 0 "Bit 63 to 32 of w_conv0"}}} {0x1c b_conv0_1 W 0x0 "Data signal of b_conv0" {{0 32 b_conv0 W 0 "Bit 31 to 0 of b_conv0"}}} {0x20 b_conv0_2 W 0x0 "Data signal of b_conv0" {{0 32 b_conv0 W 0 "Bit 63 to 32 of b_conv0"}}} {0x28 w_conv1_1 W 0x0 "Data signal of w_conv1" {{0 32 w_conv1 W 0 "Bit 31 to 0 of w_conv1"}}} {0x2c w_conv1_2 W 0x0 "Data signal of w_conv1" {{0 32 w_conv1 W 0 "Bit 63 to 32 of w_conv1"}}} {0x34 b_conv1_1 W 0x0 "Data signal of b_conv1" {{0 32 b_conv1 W 0 "Bit 31 to 0 of b_conv1"}}} {0x38 b_conv1_2 W 0x0 "Data signal of b_conv1" {{0 32 b_conv1 W 0 "Bit 63 to 32 of b_conv1"}}} {0x40 w_fc0_1 W 0x0 "Data signal of w_fc0" {{0 32 w_fc0 W 0 "Bit 31 to 0 of w_fc0"}}} {0x44 w_fc0_2 W 0x0 "Data signal of w_fc0" {{0 32 w_fc0 W 0 "Bit 63 to 32 of w_fc0"}}} {0x4c b_fc0_1 W 0x0 "Data signal of b_fc0" {{0 32 b_fc0 W 0 "Bit 31 to 0 of b_fc0"}}} {0x50 b_fc0_2 W 0x0 "Data signal of b_fc0" {{0 32 b_fc0 W 0 "Bit 63 to 32 of b_fc0"}}} {0x58 w_fc1_1 W 0x0 "Data signal of w_fc1" {{0 32 w_fc1 W 0 "Bit 31 to 0 of w_fc1"}}} {0x5c w_fc1_2 W 0x0 "Data signal of w_fc1" {{0 32 w_fc1 W 0 "Bit 63 to 32 of w_fc1"}}} {0x64 b_fc1_1 W 0x0 "Data signal of b_fc1" {{0 32 b_fc1 W 0 "Bit 31 to 0 of b_fc1"}}} {0x68 b_fc1_2 W 0x0 "Data signal of b_fc1" {{0 32 b_fc1 W 0 "Bit 63 to 32 of b_fc1"}}} {0x70 feature_in_1 W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 31 to 0 of feature_in"}}} {0x74 feature_in_2 W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 63 to 32 of feature_in"}}} {0x7c feature_out_1 W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 31 to 0 of feature_out"}}} {0x80 feature_out_2 W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 63 to 32 of feature_out"}}} {0x88 result_1 W 0x0 "Data signal of result" {{0 32 result W 0 "Bit 31 to 0 of result"}}} {0x8c result_2 W 0x0 "Data signal of result" {{0 32 result W 0 "Bit 63 to 32 of result"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1440328 II x}
...
source -notrace "E:/Downloadcache/Xilinx/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"
