...
`define AUTOTB_DUT      lenet5
`define AUTOTB_DUT_INST AESL_inst_lenet5
`define AUTOTB_TOP      apatb_lenet5_top
`define AUTOTB_LAT_RESULT_FILE "lenet5.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "lenet5.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_lenet5_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_w_conv0 1
`define AESL_DEPTH_b_conv0 1
`define AESL_DEPTH_w_conv1 1
`define AESL_DEPTH_b_conv1 1
`define AESL_DEPTH_w_fc0 1
`define AESL_DEPTH_b_fc0 1
`define AESL_DEPTH_w_fc1 1
`define AESL_DEPTH_b_fc1 1
`define AESL_DEPTH_feature_in 1
`define AESL_DEPTH_feature_out 1
`define AESL_DEPTH_result 1
`define AUTOTB_TVIN_gmem  "./c.lenet5.autotvin_gmem.dat"
`define AUTOTB_TVIN_w_conv0  "./c.lenet5.autotvin_w_conv0.dat"
`define AUTOTB_TVIN_b_conv0  "./c.lenet5.autotvin_b_conv0.dat"
`define AUTOTB_TVIN_w_conv1  "./c.lenet5.autotvin_w_conv1.dat"
`define AUTOTB_TVIN_b_conv1  "./c.lenet5.autotvin_b_conv1.dat"
`define AUTOTB_TVIN_w_fc0  "./c.lenet5.autotvin_w_fc0.dat"
`define AUTOTB_TVIN_b_fc0  "./c.lenet5.autotvin_b_fc0.dat"
`define AUTOTB_TVIN_w_fc1  "./c.lenet5.autotvin_w_fc1.dat"
`define AUTOTB_TVIN_b_fc1  "./c.lenet5.autotvin_b_fc1.dat"
`define AUTOTB_TVIN_feature_in  "./c.lenet5.autotvin_feature_in.dat"
`define AUTOTB_TVIN_feature_out  "./c.lenet5.autotvin_feature_out.dat"
`define AUTOTB_TVIN_result  "./c.lenet5.autotvin_result.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.lenet5.autotvin_gmem.dat"
`define AUTOTB_TVIN_w_conv0_out_wrapc  "./rtl.lenet5.autotvin_w_conv0.dat"
`define AUTOTB_TVIN_b_conv0_out_wrapc  "./rtl.lenet5.autotvin_b_conv0.dat"
`define AUTOTB_TVIN_w_conv1_out_wrapc  "./rtl.lenet5.autotvin_w_conv1.dat"
`define AUTOTB_TVIN_b_conv1_out_wrapc  "./rtl.lenet5.autotvin_b_conv1.dat"
`define AUTOTB_TVIN_w_fc0_out_wrapc  "./rtl.lenet5.autotvin_w_fc0.dat"
`define AUTOTB_TVIN_b_fc0_out_wrapc  "./rtl.lenet5.autotvin_b_fc0.dat"
`define AUTOTB_TVIN_w_fc1_out_wrapc  "./rtl.lenet5.autotvin_w_fc1.dat"
`define AUTOTB_TVIN_b_fc1_out_wrapc  "./rtl.lenet5.autotvin_b_fc1.dat"
`define AUTOTB_TVIN_feature_in_out_wrapc  "./rtl.lenet5.autotvin_feature_in.dat"
`define AUTOTB_TVIN_feature_out_out_wrapc  "./rtl.lenet5.autotvin_feature_out.dat"
`define AUTOTB_TVIN_result_out_wrapc  "./rtl.lenet5.autotvin_result.dat"
`define AUTOTB_TVOUT_gmem  "./c.lenet5.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.lenet5.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1440328;
parameter LENGTH_gmem = 80997;
parameter LENGTH_w_conv0 = 1;
parameter LENGTH_b_conv0 = 1;
parameter LENGTH_w_conv1 = 1;
parameter LENGTH_b_conv1 = 1;
parameter LENGTH_w_fc0 = 1;
parameter LENGTH_b_fc0 = 1;
parameter LENGTH_w_fc1 = 1;
parameter LENGTH_b_fc1 = 1;
...
reg end_w_conv0;
reg [31:0] size_w_conv0;
reg [31:0] size_w_conv0_backup;
reg end_b_conv0;
reg [31:0] size_b_conv0;
reg [31:0] size_b_conv0_backup;
reg end_w_conv1;
reg [31:0] size_w_conv1;
reg [31:0] size_w_conv1_backup;
reg end_b_conv1;
reg [31:0] size_b_conv1;
reg [31:0] size_b_conv1_backup;
reg end_w_fc0;
reg [31:0] size_w_fc0;
reg [31:0] size_w_fc0_backup;
reg end_b_fc0;
reg [31:0] size_b_fc0;
reg [31:0] size_b_fc0_backup;
reg end_w_fc1;
reg [31:0] size_w_fc1;
reg [31:0] size_w_fc1_backup;
reg end_b_fc1;
reg [31:0] size_b_fc1;
reg [31:0] size_b_fc1_backup;
reg end_feature_in;
