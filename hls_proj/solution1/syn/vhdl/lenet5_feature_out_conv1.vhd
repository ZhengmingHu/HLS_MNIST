...
entity lenet5_feature_out_conv1_ram is 
    generic(
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 11; 
...
architecture rtl of lenet5_feature_out_conv1_ram is 
...
entity lenet5_feature_out_conv1 is
    generic (
...
architecture arch of lenet5_feature_out_conv1 is
    component lenet5_feature_out_conv1_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    lenet5_feature_out_conv1_ram_U :  component lenet5_feature_out_conv1_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
