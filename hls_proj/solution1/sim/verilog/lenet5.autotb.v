...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_gmem.dat"
`define AUTOTB_TVIN_w_conv0_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_w_conv0.dat"
`define AUTOTB_TVIN_b_conv0_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_b_conv0.dat"
`define AUTOTB_TVIN_w_conv1_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_w_conv1.dat"
`define AUTOTB_TVIN_b_conv1_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_b_conv1.dat"
`define AUTOTB_TVIN_w_fc0_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_w_fc0.dat"
`define AUTOTB_TVIN_b_fc0_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_b_fc0.dat"
`define AUTOTB_TVIN_w_fc1_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_w_fc1.dat"
`define AUTOTB_TVIN_b_fc1_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_b_fc1.dat"
`define AUTOTB_TVIN_feature_in_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_feature_in.dat"
`define AUTOTB_TVIN_feature_out_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_feature_out.dat"
`define AUTOTB_TVIN_result_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvin_result.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.lenet5.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.lenet5.autotvout_gmem.dat"
module `AUTOTB_TOP;
