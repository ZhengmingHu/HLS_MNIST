...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Downloadcache/Xilinx/Vitis_HLS/2020.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/Downloadcache/Xilinx/Vitis_HLS/2020.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Downloadcache/Xilinx/Vitis_HLS/2020.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Downloadcache/Xilinx/Vitis_HLS/2020.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lenet5.autotvin.dat"
	set constFileTvOut       "lenet5.autotvout.dat"
	set constFileHdlTvIn     "lenet5.autohdltvin.dat"
	set constFileHdlTvOut    "lenet5.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
